...
Built for a 27-year-old retail investor with an aggressive growth portfolio. Existing holdings: META (~6%), NVDA (27%), VTI (26%), VRT (16%), MU (6%), MSFT (5%), AMZN (3%), CRWD (3%), ANET (~3%), AAPL (~1.5%), APP (new). AI hardware cluster ~41% — flag concentration in screener.

Watch prices established through evidence-based skill framework:
- GOOGL $375 — at all-time high of $403, consensus PT below current price
- RKLB $95 — trading above highest analyst PT of $120
- NBIS $185 — 16% single-day earnings pop, wait for exhale
- CRDO $155 — only 3% PT upside at current price

Screener uses same 6-criterion growth-mode framework: rev growth >20%, buy consensus ≥80%, ≤1 sell rating, price 10-40% below 52wk high, PT upside ≥15%, market cap >$2B.
